...
class Tenth(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.button_c2r1 = Button(self, image=self.button_imgDisagree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_1("c2r1", controller, "HUMSS", "Social and Cultural Awareness"), relief="flat")
        self.button_c2r1.place(x=566.0, y=94.0, width=50.0, height=48.0)

        # creating c3r1 neutral button
        self.button_c3r1 = Button(self, image=self.button_imgNeutral, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_1("c3r1", controller, "HUMSS", "Social and Cultural Awareness"), relief="flat")
        self.button_c3r1.place(x=685.0, y=102.0, width=35.0, height=33.0)

        # creating c4r1 agree button
        self.button_c4r1 = Button(self, image=self.button_imgAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_1("c4r1", controller, "HUMSS", "Social and Cultural Awareness"), relief="flat")
        self.button_c4r1.place(x=789.0, y=94.0, width=50.0, height=48.0)
        ...
        self.button_c5r1 = Button(self, image=self.button_imgStronglyAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_1("c5r1", controller, "HUMSS", "Social and Cultural Awareness"), relief="flat")
        self.button_c5r1.place(x=908.0, y=84.0, width=70.0, height=68.0)
        ...
        self.button_c1r2 = Button(self, image=self.button_imgStronglyDisagree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_2( "c1r2", controller, "ABM", "Financial Management"), relief="flat")
        self.button_c1r2.place(x=427.0, y=215.0, width=70.0, height=68.0)
        ...
        self.button_c2r2 = Button(self, image=self.button_imgDisagree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_2( "c2r2", controller, "ABM", "Financial Management"), relief="flat")
        self.button_c2r2.place(x=566.0, y=225.0, width=50.0, height=48.0)

        # creating c3r2 neutral button
        self.button_c3r2 = Button(self, image=self.button_imgNeutral, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_2("c3r2", controller, "ABM", "Financial Management"), relief="flat")
        self.button_c3r2.place(x=685.0, y=233.0, width=35.0, height=33.0)

        # creating c4r2 agree button
        self.button_c4r2 = Button(self, image=self.button_imgAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_2( "c4r2", controller, "ABM", "Financial Management"), relief="flat")
        self.button_c4r2.place(x=789.0, y=225.0, width=50.0, height=48.0)
        ...
        self.button_c5r2 = Button(self, image=self.button_imgStronglyAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_2( "c5r2", controller, "ABM", "Financial Management"),
                             relief="flat")
        self.button_c5r2.place(x=908.0, y=215.0, width=70.0, height=68.0)
        ...
        self.button_c1r3 = Button(self, image=self.button_imgStronglyDisagree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_3( "c1r3", controller, "ICT", "Innovative"), relief="flat")
        self.button_c1r3.place(x=427.0, y=346.0, width=70.0, height=68.0)
        ...
        self.button_c2r3 = Button(self, image=self.button_imgDisagree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_3( "c2r3", controller, "ICT", "Innovative"), relief="flat")
        self.button_c2r3.place(x=566.0, y=356.0, width=50.0, height=48.0)

        # creating c3r3 neutral button
        self.button_c3r3 = Button(self, image=self.button_imgNeutral, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_3( "c3r3", controller, "ICT", "Innovative"), relief="flat")
        self.button_c3r3.place(x=685.0, y=364.0, width=35.0, height=33.0)

        # creating c4r3 agree button
        self.button_c4r3 = Button(self, image=self.button_imgAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_3( "c4r3", controller, "ICT", "Innovative"), relief="flat")
        self.button_c4r3.place(x=789.0, y=356.0, width=50.0, height=48.0)
        ...
        self.button_c5r3 = Button(self, image=self.button_imgStronglyAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_3( "c5r3", controller, "ICT", "Innovative"), relief="flat")
        self.button_c5r3.place(x=908.0, y=346.0, width=70.0, height=68.0)
        ...
        self.button_c1r4 = Button(self, image=self.button_imgStronglyDisagree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_4( "c1r4", controller, "ABM", "Business"), relief="flat")
        self.button_c1r4.place(x=427.0, y=478.0, width=70.0, height=68.0)
        ...
        self.button_c2r4 = Button(self, image=self.button_imgDisagree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_4( "c2r4", controller, "ABM", "Business"), relief="flat")
        self.button_c2r4.place(x=566.0, y=489.0, width=50.0, height=48.0)

        # creating c3r4 neutral button
        self.button_c3r4 = Button(self, image=self.button_imgNeutral, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_4( "c3r4", controller, "ABM", "Business"), relief="flat")
        self.button_c3r4.place(x=685.0, y=496.0, width=35.0, height=33.0)

        # creating c4r4 agree button
        self.button_c4r4 = Button(self, image=self.button_imgAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_4( "c4r4", controller, "ABM", "Business"), relief="flat")
        self.button_c4r4.place(x=789.0, y=488.0, width=50.0, height=48.0)
        ...
        self.button_c5r4 = Button(self, image=self.button_imgStronglyAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_4( "c5r4", controller, "ABM", "Business"), relief="flat")
        self.button_c5r4.place(x=908.0, y=478.0, width=70.0, height=68.0)
        ...
        self.button_c1r5 = Button(self, image=self.button_imgStronglyDisagree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_5( "c1r5", controller, "HUMSS", "Communication"),
                             relief="flat")
        self.button_c1r5.place(x=427.0, y=609.0, width=70.0, height=68.0)
        ...
        self.button_c2r5 = Button(self, image=self.button_imgDisagree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_5("c2r5", controller, "HUMSS", "Communication"), relief="flat")
        self.button_c2r5.place(x=566.0, y=619.0, width=50.0, height=48.0)

        # creating c3r5 neutral button
        self.button_c3r5 = Button(self, image=self.button_imgNeutral, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_5( "c3r5", controller, "HUMSS", "Communication"), relief="flat")
        self.button_c3r5.place(x=685.0, y=627.0, width=35.0, height=33.0)

        # creating c4r5 agree button
        self.button_c4r5 = Button(self, image=self.button_imgAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_5("c4r5", controller, "HUMSS", "Communication"), relief="flat")
        self.button_c4r5.place(x=789.0, y=619.0, width=50.0, height=48.0)
        ...
        self.button_c5r5 = Button(self, image=self.button_imgStronglyAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.row_5( "c5r5", controller, "HUMSS", "Communication"), relief="flat")
        self.button_c5r5.place(x=908.0, y=609.0, width=70.0, height=68.0)
