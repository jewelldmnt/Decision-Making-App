...
class first(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button_Next = Button(image=self.button_imgNext, borderwidth=0, highlightthickness=0,
                             command=lambda: print("button_Next clicked"), relief="flat")
        ...
        button_c3r1 = Button(image=self.button_imgNeutral, borderwidth=0, highlightthickness=0,
                             command=lambda: self.neutral(controller, button_c3r1), relief="flat")
        button_c3r1.place(x=662.9999999999999, y=72.0, width=35.0, height=33.0)

        # creating c4r1 agree button
        button_c4r1 = Button(image=self.button_imgAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.agree(controller, button_c4r1), relief="flat")
        button_c4r1.place(x=766.9999999999999, y=64.0, width=50.0, height=48.0)

        # creating c5r1 strongly agree button
        button_c5r1 = Button(image=self.button_imgStronglyAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.strongly_agree(controller, button_c5r1), relief="flat")
        button_c5r1.place(x=885.9999999999999, y=54.0, width=70.0, height=68.0)

        # creating c1r2 strongly disagree button
        button_c1r2 = Button(image=self.button_imgStronglyDisagree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.strongly_disagree(controller, button_c1r2), relief="flat")
        button_c1r2.place(x=404.9999999999999, y=215.0, width=70.0, height=68.0)

        # creating c2r2 disagree button
        button_c2r2 = Button(image=self.button_imgDisagree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.disagree(controller, button_c2r2), relief="flat")
        button_c2r2.place(x=543.9999999999999, y=225.0, width=50.0, height=48.0)

        # creating c3r2 neutral button
        button_c3r2 = Button(image=self.button_imgNeutral, borderwidth=0, highlightthickness=0,
                             command=lambda: self.neutral(controller, button_c3r2), relief="flat")
        button_c3r2.place(x=662.9999999999999, y=233.0, width=35.0, height=33.0)

        # creating c4r2 agree button
        button_c4r2 = Button(image=self.button_imgAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.agree(controller, button_c4r1), relief="flat")
        button_c4r2.place(x=766.9999999999999, y=225.0, width=50.0, height=48.0)

        # creating c5r2 strongly agree button
        button_c5r2 = Button(image=self.button_imgStronglyAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.strongly_agree(controller, button_c5r2), relief="flat")
        button_c5r2.place(x=885.9999999999999, y=215.0, width=70.0, height=68.0)

        # creating c1r3 strongly disagree button
        button_c1r3 = Button(image=self.button_imgStronglyDisagree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.strongly_disagree(controller, button_c1r3), relief="flat")
        button_c1r3.place(x=404.9999999999999, y=346.0, width=70.0, height=68.0)

        # creating c2r3 disagree button
        button_c2r3 = Button(image=self.button_imgDisagree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.disagree(controller, button_c2r3), relief="flat")
        button_c2r3.place(x=543.9999999999999, y=356.0, width=50.0, height=48.0)

        # creating c3r3 neutral button
        button_c3r3 = Button(image=self.button_imgNeutral, borderwidth=0, highlightthickness=0,
                             command=lambda: self.neutral(controller, button_c3r3), relief="flat")
        button_c3r3.place(x=662.9999999999999, y=364.0, width=35.0, height=33.0)

        # creating c4r3 agree button
        button_c4r3 = Button(image=self.button_imgAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.agree(controller, button_c4r3), relief="flat")
        button_c4r3.place(x=766.9999999999999, y=356.0, width=50.0, height=48.0)

        # creating c5r3 strongly agree button
        button_c5r3 = Button(image=self.button_imgStronglyAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.strongly_agree(controller, button_c5r3), relief="flat")
        button_c5r3.place(x=885.9999999999999, y=346.0, width=70.0, height=68.0)

        # creating c1r4 strongly disagree button
        button_c1r4 = Button(image=self.button_imgStronglyDisagree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.strongly_disagree(controller, button_c1r4), relief="flat")
        button_c1r4.place(x=404.9999999999999, y=478.0, width=70.0, height=68.0)

        # creating c2r4 disagree button
        button_c2r4 = Button(image=self.button_imgDisagree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.disagree(controller, button_c2r4), relief="flat")
        button_c2r4.place(x=543.9999999999999, y=488.0, width=50.0, height=48.0)

        # creating c3r4 neutral button
        button_c3r4 = Button(image=self.button_imgNeutral, borderwidth=0, highlightthickness=0,
                             command=lambda: self.neutral(controller, button_c3r4), relief="flat")
        button_c3r4.place(x=662.9999999999999, y=496.0, width=35.0, height=33.0)

        # creating c4r4 agree button
        button_c4r4 = Button(image=self.button_imgAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.agree(controller, button_c4r4), relief="flat")
        button_c4r4.place(x=766.9999999999999, y=488.0, width=50.0, height=48.0)

        # creating c5r4 strongly agree button
        button_c5r4 = Button(image=self.button_imgStronglyAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.strongly_agree(controller, button_c5r4), relief="flat")
        button_c5r4.place(x=885.9999999999999, y=478.0, width=70.0, height=68.0)

        # creating c1r5 strongly disagree button
        button_c1r5 = Button(image=self.button_imgStronglyDisagree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.strongly_disagree(controller, button_c1r5), relief="flat")
        button_c1r5.place(x=404.9999999999999, y=609.0, width=70.0, height=68.0)

        # creating c2r5 disagree button
        button_c2r5 = Button(image=self.button_imgDisagree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.disagree(controller, button_c2r5), relief="flat")
        button_c2r5.place(x=543.9999999999999, y=619.0, width=50.0, height=48.0)

        # creating c3r5 neutral button
        button_c3r5 = Button(image=self.button_imgNeutral, borderwidth=0, highlightthickness=0,
                             command=lambda: self.neutral(controller, button_c3r5), relief="flat")
        button_c3r5.place(x=662.9999999999999, y=627.0, width=35.0, height=33.0)

        # creating c4r5 agree button
        button_c4r5 = Button(image=self.button_imgAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.agree(controller, button_c4r5), relief="flat")
        button_c4r5.place(x=766.9999999999999, y=619.0, width=50.0, height=48.0)

        # creating c5r5 strongly agree button
        button_c5r5 = Button(image=self.button_imgStronglyAgree, borderwidth=0, highlightthickness=0,
                             command=lambda: self.strongly_agree(controller, button_c5r5), relief="flat")
