...
class STEM(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # creating the background design for STEM page
        self.videoplayer = TkinterVideo(master=self, scaled=True)
        self.videoplayer.load("ResultPage/STEM/assets/stem.mp4")
    ...
    def play(self):
        pygame.mixer.music.load("ResultPage/STEM/assets/song.mp3")
