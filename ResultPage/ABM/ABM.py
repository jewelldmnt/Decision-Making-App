...
class ABM(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # creating the background design for ABM page
        self.videoplayer = TkinterVideo(master=self, scaled=True)
        self.videoplayer.load("ResultPage/ABM/assets/abm.mp4")
    ...
    def play(self):
        pygame.mixer.music.load("ResultPage/ABM/assets/song.mp3")
