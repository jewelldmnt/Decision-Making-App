...
ASSETS_PATH = OUTPUT_PATH / Path(r"middle assets")
...
button_imgBack = PhotoImage(
    file=relative_to_assets("button_Back.png"))
button_Back = Button(
    image=button_imgBack,
    borderwidth=0,
    highlightthickness=0,
...
button_imgNext = PhotoImage(
    file=relative_to_assets("button_Next.png"))
button_Next = Button(
    image=button_imgNext,
    borderwidth=0,
    highlightthickness=0,
...
button_image_28 = PhotoImage(
    file=relative_to_assets("button_SoundsOn.png"))
button_28 = Button(
...
button_image_29 = PhotoImage(
    file=relative_to_assets("button_SoundsOff.png"))
button_29 = Button(
